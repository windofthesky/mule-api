...
public class TraversableStreamTestCase extends AbstractByteStreamingTestCase {
  ...
  @Test
  public void twoConcurrentCursorsReadingOppositeEndsOfTheStreamInSingleThread() throws Exception {
    CursorStream cursor1 = stream.openCursor();
    CursorStream cursor2 = stream.openCursor();
  ...
  @Test
  public void twoConcurrentCursorsReadingOppositeEndsOfTheStreamConcurrently() throws Exception {
    CursorStream cursor1 = stream.openCursor();
    CursorStream cursor2 = stream.openCursor();
